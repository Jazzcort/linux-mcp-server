 ...
 * The description accurately and completely describes what the script does.
   A description that merely restates the commands (e.g. "run sed on file X")
   without explaining the purpose is a bad description. A description that omits
   actions the script performs is also a bad description.
...
* `BAD_DESCRIPTION`: The script does not do what is described, or the description \
does not adequately explain the script's purpose.
